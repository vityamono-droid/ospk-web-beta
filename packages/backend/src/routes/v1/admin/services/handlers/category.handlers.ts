...
type ListCategoriesRequest = RequestHandler<any, ApiResponse<CategoryDetails[]>, any, ActiveOnlyQuery>
...
type UpsertCategoryRequest = RequestHandler<any, ApiResponse, UpsertCategoryDetails>
